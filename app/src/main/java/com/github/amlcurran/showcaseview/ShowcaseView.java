...
public class ShowcaseView extends RelativeLayout
    ...
    private void init() {
        ...
        if (mSkipButton.getParent() == null) {
            int margin = (int) getResources().getDimension(R.dimen.button_margin);
            LayoutParams lps2 = (LayoutParams) generateDefaultLayoutParams();
...
//            lps2.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
            ...
            mSkipButton.setLayoutParams(lps2);
            mSkipButton.setText(android.R.string.ok);
            if (!hasCustomClickListener) {
    ...
    private void updateStyle(TypedArray styled, boolean invalidate) {
        ...
        mSkipButton.setText(buttonText);
